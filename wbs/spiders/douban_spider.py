...
class DouBanSpider(scrapy.Spider):
	...
	def parse(self, response):
		...
		# 通过登录豆瓣获取cookies
		# self.get_douban_cookies_by_login()
		# yield scrapy.Request(url=self.start_urls[0], callback=self.get_douban_film_data)
		""" 获取电影数据 """
		...
		# # 获取下一页链接
		# next_link = html.xpath('.//span[@class="next"]/link/@href').extract_first()
		# if next_link != None:
		# 	# 请求下一页规则
